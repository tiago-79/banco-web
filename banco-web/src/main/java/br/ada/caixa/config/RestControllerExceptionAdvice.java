...
public class RestControllerExceptionAdvice {
    ...
    public ResponseEntity<List<ErrorResponseDto>> handlerMethodArgumentNotValidException(MethodArgumentNotValidException exception) {
        List<ErrorResponseDto> erros = exception.getBindingResult()
                .getAllErrors()
                .stream()
                .map(objectError -> {
