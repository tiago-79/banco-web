...
public class ClientePFController {
    ...
    @PostMapping("/criar")
    public ResponseEntity<ClientePFResponseDto> criar (@RequestBody ClientePFRequestDto clientePFRequestDto){
    ...
    @GetMapping("/{cpf}")
    public ResponseEntity<ClientePFResponseDto> getPorCpf(@PathVariable String cpf){
